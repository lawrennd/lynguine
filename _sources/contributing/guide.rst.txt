...
- Increase the version numbers in any examples files and the README.md to the new version that this Pull Request would represent. The versioning scheme we use is `SemVer <http://semver.org/>`_.
...
1. Follow the `style guides`_
2. After you submit your pull request, verify that all `status checks`_ are passing
...
.. _style guides: #style-guides
.. _status checks: https://help.github.com/articles/about-status-checks/
