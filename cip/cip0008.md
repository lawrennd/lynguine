...
- ✅ **Future-proof**: Remote access comes for free
...
With server (Unix sockets):
  Startup: 1,900ms
  Requests: 100 × 0.01ms = 1ms
  Total: 1,901ms = 1.9 seconds
  Improvement: 100x faster

Verdict: HTTP vs Unix sockets = 2.1s vs 1.9s
         Difference is NEGLIGIBLE compared to 190s baseline
         Choose HTTP for portability
```
