# Migration Guide: From Direct Mode to Server Mode
...
```python
# Simply replace client calls with direct calls
# Before (server mode):
from lynguine.client import ServerClient
client = ServerClient()
...
- **CIP**: [CIP-0008](../../cip/cip0008.md)
- **Requirement**: [REQ-0007](../../requirements/req0007_fast-repeated-access.md)
- **Tests**: `pytest lynguine/tests/test_server_mode.py -v`
